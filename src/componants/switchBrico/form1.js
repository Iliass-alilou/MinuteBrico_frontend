            ...
            />
                ...
                <form>
                  <div className="form-outline mb-4 md-5">
                    ...
                    <input type="text" id="form5Example1" className="form-control" id="firstName" name="firstName1" value={values.firstName1} required />
                  </div>

                  <div className="form-outline mb-4 md-5">
                    <label className="form-label" htmlFor="form5Example1">Votre Prénom<span style={{color:'red'}}>*</span> </label>
                    <input type="text" id="form5Example1" className="form-control" id="lastName" name="lastName1" value={values.lastName1}  required />
                  </div>

                  <div className="form-outline mb-4 md-5">
                    <label className="form-label" htmlFor="form5Example1">Nom d'affichage <span style={{color:'red'}}>*</span> </label>
                    <input type="text" id="form5Example1" className="form-control" id="showName" name="showName1" value={values.showName1} required />
                  </div>
